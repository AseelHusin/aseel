...
// استدعاء دالة العرض عند تحميل الصفحة لأول مرة لتحميل المهام المحفوظة
showTask();

// ===================================
// 1. دالة إضافة مهمة جديدة (Add Task)
// يتم استدعاؤها بالنقر على زر "إضافة" أو بضغط Enter
// ===================================
function addTask() {
...
// ===================================
// 3. إضافة وظيفة الإدخال بزر Enter
// ===================================
inputBox.addEventListener("keypress", function(event) {
    // التحقق مما إذا كان المفتاح الذي ضغط عليه هو "Enter"
    if (event.key === "Enter") {
        // منع السلوك الافتراضي لزر Enter
        event.preventDefault(); 
        // استدعاء دالة إضافة المهمة
        addTask();
    }
});
